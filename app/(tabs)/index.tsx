...
import { FileText, Plus, Trash2, Edit2, Search, Clock, FileCode } from 'lucide-react-native';
      ...
      <View style={styles.fileActions}>
        <TouchableOpacity
          ...
          onPress={() => {
            ...
            setRenameValue(item.name.replace(/\.html$/, ''));
            setShowRename(true);
          }}>
      ...
      {filteredFiles.length === 0 ? (
        <View style={styles.emptyState}>
          ...
          <Text style={styles.emptyText}>
            {search ? 'No files match your search' : 'Create your first HTML file to get started'}
          </Text>
          {!search && (
            <TouchableOpacity
...
const styles = StyleSheet.create({
  ...
  header: { paddingHorizontal: Spacing.lg, paddingTop: Spacing.xxl, paddingBottom: Spacing.md } as ViewStyle,
  ...
  fileActions: { flexDirection: 'row', gap: Spacing.sm } as ViewStyle,
